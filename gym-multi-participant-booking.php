	...
	public function enqueue_frontend_scripts() {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'            => array(
					'participantLabel'  => __( 'Participant', 'gym-multi-participant-booking' ),
					'nameLabel'         => __( 'Name', 'gym-multi-participant-booking' ),
					'emailLabel'        => __( 'Email Address', 'gym-multi-participant-booking' ),
					'phoneLabel'        => __( 'Phone Number', 'gym-multi-participant-booking' ),
					'namePlaceholder'   => __( 'Full Name', 'gym-multi-participant-booking' ),
					'emailPlaceholder'  => __( 'email@example.com', 'gym-multi-participant-booking' ),
					'phonePlaceholder'  => __( '+1 (555) 000-0000', 'gym-multi-participant-booking' ),
					...
					'nameRequired'      => __( 'Please enter participant name', 'gym-multi-participant-booking' ),
					...
					'phoneRequired'     => __( 'Please enter phone number', 'gym-multi-participant-booking' ),
					'duplicateEmail'    => __( 'Each participant must have a unique email address', 'gym-multi-participant-booking' ),
